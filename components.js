          ...
          <div class="nav-links" role="list">
            ...
            <div class="nav-dropdown" role="listitem">
              ...
              <div class="nav-dropdown-menu" id="dropdown-categories" role="menu" aria-label="Catégories">
                ...
                <a href="/categories#n8n" class="nav-dropdown-item" role="menuitem">
                ...
                <a href="/categories#outils" class="nav-dropdown-item" role="menuitem">
                ...
                <a href="/categories#business" class="nav-dropdown-item" role="menuitem">
        ...
        <div class="nav-mobile" id="navMobile" role="menu" aria-label="Menu mobile">
          ...
          <div class="nav-mobile-accordion">
            ...
            <div class="nav-mobile-submenu" id="mobile-categories">
              <a href="/categories#ia" class="nav-mobile-sublink" role="menuitem">🤖 IA &amp; Automatisation</a>
              <a href="/categories#n8n" class="nav-mobile-sublink" role="menuitem">⚡ Workflows N8N</a>
              <a href="/categories#outils" class="nav-mobile-sublink" role="menuitem">🛠️ Outils &amp; Apps</a>
              <a href="/categories#business" class="nav-mobile-sublink" role="menuitem">📈 Business &amp; Stratégie</a>
      ...
      <div class="container">
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <ul>
              <li><a href="/categories#ia">IA &amp; Automatisation</a></li>
