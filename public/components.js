...
(function () {
          ...
          <div class="nav-links" role="list">
            ...
            <div class="nav-dropdown" role="listitem">
              ...
              <div class="nav-dropdown-menu" id="dropdown-categories" role="menu" aria-label="Catégories">
                <a href="categorie-ia-automatisation.html" class="nav-dropdown-item" role="menuitem">
                  ...
                  <span class="nav-dropdown-text">
                    ...
                    <span class="nav-dropdown-desc">IA, workflows, no-code, productivité</span>
                  </span>
                </a>
                ...
                <a href="categorie-outils-apps.html" class="nav-dropdown-item" role="menuitem">
                  ...
                  <span class="nav-dropdown-text">
                    ...
                    <span class="nav-dropdown-desc">Comparatifs, apps, SaaS, avis</span>
                  </span>
                </a>
        ...
        <div class="nav-mobile" id="navMobile" role="menu" aria-label="Menu mobile">
          ...
          <div class="nav-mobile-accordion">
            ...
            <div class="nav-mobile-submenu" id="mobile-categories">
              <a href="categorie-ia-automatisation.html" class="nav-mobile-sublink" role="menuitem">🤖 IA &amp; Automatisation</a>
              <a href="categorie-acquisition.html" class="nav-mobile-sublink" role="menuitem">🎯 Acquisition</a>
              <a href="categorie-assurances-finances.html" class="nav-mobile-sublink" role="menuitem">💰 Finances &amp; Assurances</a>
              <a href="categorie-outils-apps.html" class="nav-mobile-sublink" role="menuitem">🛠️ Outils &amp; Logiciels</a>
      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-brand">
            ...
            <p class="footer-desc">
              Le média pratique pour les entrepreneurs qui veulent automatiser leur activité,
              choisir les bons outils, attirer des clients et gérer leur business plus simplement.
            </p>
          </div>
          ...
          <div class="footer-col">
            ...
            <ul>
              <li><a href="categorie-ia-automatisation.html">IA &amp; Automatisation</a></li>
              <li><a href="categorie-acquisition.html">Acquisition</a></li>
              <li><a href="categorie-assurances-finances.html">Finances &amp; Assurances</a></li>
              <li><a href="categorie-outils-apps.html">Outils &amp; Logiciels</a></li>
            </ul>
          </div>
  ...
  function setActiveNavLink() {
    ...
    const links = document.querySelectorAll('.nav-link, .nav-dropdown-item, .nav-mobile-sublink');
  ...
  function initMobileAccordion() {
    ...
    accTrigger.addEventListener('click', () => {
      ...
      const arrow = accTrigger.querySelector('.nav-dropdown-arrow');
